...
def getRandomFortune():
    ...
    fortunes = [
        ...
        "You have tamed the mighty Python, now you must free it into the Great Spiders Web!"
    ]
...
class MainHandler(webapp2.RequestHandler):
    def get(self):
        ...
        coookie_agian_button = "<a href='.'><button>Another cookie plz!</button></a>"

        content = header + fortune_paragraph + number_paragraph + coookie_agian_button
